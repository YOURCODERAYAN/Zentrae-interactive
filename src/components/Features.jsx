...
// important concept of tilting effect on card component 
...
// important concept of hovering button effect
                    ...
                    <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
                        <div>
                            <h1 className="bento-title special-font">{title}</h1>
                                {
                                    description &&(
                                    <p className="mt-3 max-w-64 md:text-base text-xs">{description}</p>
                                    )
                                }
                        </div>

                        {
                            ...
                            className="border-hsla relative flex w-fit cursor-pointer items-center gap-1 overflow-hidden rounded-full bg-black px-5 py-2 text-xs uppercase text-black"
                                >
